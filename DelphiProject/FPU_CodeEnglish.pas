...
begin
  ...
  if (Numero.Text ='p') or (Numero.Text ='pi') then
  begin
  ...
  if Numero.Text = 'd' then
  begin
  Numero.Text := FloatToStr (Ln(10));
  Valorc := Ln(10);
  end;
  if Numero.Text = 'b' then
  begin
  Numero.Text := FloatToStr (sqrt(2));
  Valorc := sqrt(2);
  end;
  if Numero.Text = 'c' then
  begin
  ...
  if Numero.Text = 'a' then Numero.Text := '1,61803398874989484820';
   //proporción aurea
